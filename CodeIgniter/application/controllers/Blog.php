...
class Blog extends CI_Controller {
    ...
    {
        $data['articleDepend'] = $this->blog_model->getArticleDepend();       
        $article_id = $data['articleDepend']['sort_article_name'];
        $article_name = $data['articleDepend']['sort_article_names'];
        echo json_decode(array('article_id'=>$article_id,'article_name'=>$article_name));
    }
